...
acknowledgment_md = """
### Declaration
The models and algorithms on this platform are intended solely for demonstration or testing purposes for a specific task. Please focus on the specified functionality during testing.
"""
...
"""
    ...
    notice_markdown = f"""
# 🏔️ 360 Icesword Lab GPT Platform
...
def build_demo(models):
    with gr.Blocks(
        title="360 Icesword Lab GPT Platform",
