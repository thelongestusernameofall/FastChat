...
model=../llama-2-zh/chinese-alpaca-2-13b-16k-inf1120-v10
...
#nohup python fastchat/serve/vllm_worker.py --model-path ${model} --model-names ${name} --limit-worker-concurrency 300 --controller-address http://10.176.205.21:21001 --num-gpus ${gpu_num} --conv-template ${convt} --host 10.178.11.72 --port 31000 --worker-address http://10.178.11.72:31000 --gpu-memory-utilization 0.86 --trust-remote-code >  ./logs/vllm_worker.log 2>&1 &
